      ...
      <div class="max-w-3xl mx-auto">
        <template v-if="isAuthed">
          ...
          <div class="fixed inset-x-0 bottom-6 flex justify-center pointer-events-none">
            <div class="pointer-events-auto group relative flex items-center gap-2 bg-base-700/80 backdrop-blur rounded-xl shadow-2xl px-3 py-2 text-accent-300">
              ...
              <!-- Floating message -->
              <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-50 bg-base-800 rounded-lg shadow-2xl px-3 py-2 text-sm text-accent-300 whitespace-pre-line w-[min(90vw,520px)]">
